...
- Understand the `DESCRIPTION` file and the most important package metadata
  - Declare dependencies with `Imports`, `Suggets`, `Depends`, `LinkingTo`, and `Enhances` fields
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/vQSYeGwX9yQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
