...
1. Overview the entire workflow for developing a package
...
4. Describe the process to install and experiment with the package's functions
5. Discuss the role `git` and GitHub plays in the development of a package
...
* The schedule and sign-up sheet can be found [here](https://docs.google.com/spreadsheets/d/188z71TbrgTtAWMAtKcwNXvtBhvCwqCvLO5F3hSYI1tM/edit#gid=0).
...
* Latest version is [2.4.3](https://github.com/r-lib/devtools/releases/tag/v2.4.3).
...
![](images/fork-triangle-happy.png)
