...
Lets load some packages to prepare authoring some packages!
...
- Usually this isn't needed or required for a common users (we're not common)
...
What is cool here, we already used of these packages!!!
...
Lets edit our `.Rprofile` file. If it does not exist on your computer, you can run `use_devtools() to create it.
...
Caution, Warning, HUGE RED FLAG!!!! You are not Super-person yet!
...
Linux install is the simplist (dependent on your distro of choice and package manager).
